...
namespace DaJet.Scripting
{
    public static class MsBulkInsertTranspiler
    {
        ...
        public static string BulkInsertStatement(in EntityDefinition table, in string vectorName, in string sequenceName)
        {
            bool first = true;
        ...
        public static bool GetSequenceProperty(in InsertStatement statement, out string propertyName, out string sequenceName)
        {
            propertyName = null;
            sequenceName = null;
