    ...
    public sealed class InsertTranspiler : SqlTranspiler
    {
        ...
        private void Transpile(in InsertStatement statement)
        {
            ...
            for (int p = 0; p < properties.Count; p++)
            {
                ...
                {
                    TranspileParameters(in property, in map, in columnNames, in listOfValues);
                }
                else
                {
                    TranspileDefaults(in property, in columnNames, in listOfValues);
                }
            }
        ...
        private void TranspileDefaults(in PropertyDefinition property, in List<string> columnNames, in List<string> listOfValues)
        {
        ...
        private void TranspileParameters(in PropertyDefinition property, in ColumnExpression map, in List<string> columnNames, in List<string> listOfValues)
        {
