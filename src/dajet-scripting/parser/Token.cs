namespace DaJet.Scripting
{
    public enum Token
    {
        ...
        Ignore, Script, Comment, Comma, EndOfStatement, USE, TRANSACTION, SKIP, LOCKED,
        
        IF, WHILE, BREAK, CONTINUE, RETURN, PRINT,
        ...
        UNION, ALL, UNION_ALL,
        DECLARE, PRIVATE, WITH, INSERT, VALUES, UPDATE, DELETE, OUTPUT, SET, UPSERT, IGNORE, BATCH_SIZE,
