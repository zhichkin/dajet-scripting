...
{
    public sealed class PgConsumeProcessor : ProcessorBase
    {
        ...
        public PgConsumeProcessor(in ScriptContext context, in ConsumeStatement statement)
        {
        ...
        private void SetOutputValue(in List<DataObject> table)
        {
            ...
            {
                throw new InvalidOperationException($"[PgConsumeProcessor] Unsupported output variable type: array expected.");
            }
